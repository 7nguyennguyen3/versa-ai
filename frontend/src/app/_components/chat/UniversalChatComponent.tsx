...
const UniversalChatComponent: React.FC<UniversalChatComponentProps> = ({
  ...
  const handleDemoPdfChange = (pdfUrl: string) => {
    ...
    if (pdf) {
      setCurrentPdf(pdf);
      updateMessagesFromHistory([]); // Clear messages on PDF change in demo
      setStreamingAiResponse("");
      setError(null);
            ...
            <div className="flex flex-col items-center justify-center text-center text-gray-500 flex-1 pt-10 sm:pt-20">
              ...
              <h3 className="text-xl font-medium text-gray-700">
                {selectedPdf
                  ...
                  : "Select a PDF and Chat, or start a new chat"}
              </h3>
              <p className="mt-2 text-gray-600">
                {selectedPdf
                  ? "Start by typing your question below or try a suggestion."
                  : "Use the Settings (⚙️) icon below to get started."}
              </p>
                ...
                {isDemo ? (
                  ...
                  <>
                    <DropdownMenu>
                      ...
                      >
                        {/* Optional: Add a main label */}
                        {/* <DropdownMenuLabel className="text-base font-semibold text-gray-800 px-0 pb-2">
      Chat Settings
    </DropdownMenuLabel> */}
